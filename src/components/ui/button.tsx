  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border-2 border-primary/20 bg-card text-foreground hover:bg-primary/5 hover:border-primary/40 rounded-xl",
        ...
        friendly: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-2xl shadow-soft hover:shadow-glow hover:-translate-y-0.5 font-bold",
        safe: "bg-safe text-safe-foreground hover:bg-safe/90 rounded-xl shadow-soft",
